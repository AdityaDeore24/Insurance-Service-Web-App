...
<head>
    <meta charset="utf-8">
    <title>Disapproved Agents</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="viewApprovationTable" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Approve Agent</a>
                    <a href="approvedAgentTable" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>View Approvals</a>
                    <a href="#" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>View Disapproved</a>
          ...
          <div class="container-fluid pt-4 px-4">
            <div class="bg-secondary text-center rounded p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h6 class="mb-0">Disapproved Agents</h6>
                    <a href="">Show All</a>
                </div>
                    ...
                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                        ...
                        %>
                            <tr>
                                ...
                                <td><a class="btn btn-sm btn-primary" href="approval/<%= acc.getAgentMob()%>">Approve</a></td>
                                <td><a class="btn btn-sm btn-primary" href="deletion/<%= acc.getAgentMob()%>">Delete</a></td>
                            </tr>
        				<%} %>
                        </tbody>
                    </table>
