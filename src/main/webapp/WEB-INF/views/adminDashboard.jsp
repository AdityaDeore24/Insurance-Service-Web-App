            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Admin</a>
                         <div class="dropdown-menu bg-transparent border-0">
                            <a href="adminLogin" class="dropdown-item">Log in</a>
                        </div>
                    </div>
                </div>
            </nav>
...
<!-- Form End -->
    ...
    <script src="./resources/lib/waypoints/waypoints.min.js"></scr ipt>
