        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="#" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>View Pendings</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
          ...
          <div class="container-fluid pt-4 px-4">
            <div class="bg-secondary text-center rounded p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h6 class="mb-0">Pending Status</h6>
                    <a href="">Show All</a>
                </div>
                    ...
                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                        ...
                        %>
                            <tr>
                                ...
                                <td><a class="btn btn-sm btn-primary" href="approvation/<%= acc.getAgentMob()%>">Approve</a></td>
                                <td><a class="btn btn-sm btn-primary" href="remove/<%= acc.getAgentMob()%>">Delete</a></td>
                            </tr>
                         <% } %> 
                        </tbody>
                    </table>
